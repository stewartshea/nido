...
// NIDO_DATA_DIR at a throwaway tmp folder and pins the master key + JWT
...
process.env.NIDO_DATA_DIR = mkdtempSync(path.join(os.tmpdir(), 'nido-test-'));
process.env.NIDO_MASTER_KEY = '0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
